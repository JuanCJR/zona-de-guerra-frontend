              ...
              <Card.Body>
                <Form noValidate validated={validated} onSubmit={handleSubmit}>
                  ...
                  <FloatingLabel
                    label="Fecha"
                    onChange={(e) =>
                      onChangeFecValue(e, "fec_reserva", changeState)
                    }
                  >
                    <Form.Control
                      type="date"
                  ...
                  <FloatingLabel
                    ...
                    className="mt-3"
                    onChange={(e) =>
                      onChangeDefaultValue(e, "nom_cli", changeState)
                    }
                  >
                  ...
                  <FloatingLabel
                    ...
                    className="mt-3"
                    onChange={(e) =>
                      onChangeDefaultValue(e, "ape_cli", changeState)
                    }
                  >
                    <Form.Control
                      type="text"
                  ...
                  <FloatingLabel
                    ...
                    className="mt-3"
                    onChange={(e) =>
                      onChangeDefaultValue(e, "rut_cli", changeState)
                    }
                  >
                    <Form.Control
                      type="text"
                  ...
                  <FloatingLabel
                    ...
                    className="mt-3"
                    onChange={(e) =>
                      onChangeDefaultValue(e, "telefono", changeState)
                    }
                  >
                    <Form.Control
                      type="text"
                  ...
                  <Form.Group
                    ...
                    onChange={(e) =>
                      onChangeFileValue(e, "comprobante", changeState)
                    }
                  >
                    <Form.Label className="mt-3  text-info">
                      Adjuntar Comprobante de Transferencia
                    </Form.Label>
                    <Form.Control type="file" accept="image/*" />
                  </Form.Group>
                  <Button type="submit" className="mt-3 w-100 custom-button">
            ...
            <Card bg="dark">
              <Card.Body>
                ...
                {postState.code === 200 ? (
                  <React.Fragment>
                    <p>
                      Fecha de reserva: {state.fec_reserva} {state.hora}
                    </p>
                    <p>
                      Reserva a nombre de: {state.nom_cli} {state.ape_cli}
                    </p>
